...
takeown /F "C:\Program Files\Internet Explorer" | Out-Null
icacls "C:\Program Files\Internet Explorer" /grant "$($env:USERNAME):(F)" | Out-Null
Remove-Item -Path "C:\Program Files\Internet Explorer" -Recurse -Force | Out-Null
