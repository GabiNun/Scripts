...
$appx = Get-AppxPackage *SecHealthUI; @('S-1-5-18','S-1-5-21-3939049671-854807330-977275038-1001') | % { ni "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Appx\AppxAllUserStore\EndOfLife\$_\$($appx.PackageFullName)" -Fo | Out-Null }; $appx | Remove-AppxPackage
