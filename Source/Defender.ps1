Register-ScheduledTask Defender -Ac (New-ScheduledTaskAction powershell "rm -r -fo 'C:\Program Files*\Windows Defender*','C:\ProgramData\Microsoft\Windows Defender*';sc.exe delete 'C:\ProgramData\Microsoft\Windows Defender*'") -U 'NT SERVICE\TrustedInstaller'
