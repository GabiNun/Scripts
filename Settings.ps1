...
attrib +h "$Home\.glzr" "$Home\Videos" "$Home\Searches"
attrib +h "$Home\Saved Games" "$Home\Pictures" "$Home\Music"
attrib +h "$Home\Links" "$Home\Favorites" "$Home\Documents"
attrib +h "$Home\Contacts" "C:\inetpub" "$Env:Public"
