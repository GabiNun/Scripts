...
(Measure-Command { gci C:\ -r -fo -ea 0 | where name -like '*edge*' | rm -r -fo -ea 0 }).TotalMilliseconds
(Measure-Command { gci C:\ -r -fo -ea 0 -filter *edge*|ri -r -fo -ea 0 }).TotalMilliseconds
