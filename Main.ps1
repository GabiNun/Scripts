...
schtasks /create /tn "RemoveDefenderAndSecurity" /ru "NT SERVICE\TrustedInstaller" /sc ONCE /st 00:00 /tr "cmd.exe /c regedit.exe /s C:\\Users\\Gabi\\AppData\\Local\\Temp\\RemoveDefender.reg && regedit.exe /s C:\\Users\\Gabi\\AppData\\Local\\Temp\\Remove_SecurityComp.reg" /f
