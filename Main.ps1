...
Get-AppxPackage | ? PackageFullName | ? {!$_.IsFramework -and !$_.NonRemovable} | % {Try {Remove-AppxPackage $_} Catch {}}
...
$appx=Get-AppxPackage -AllUsers -Name "Microsoft.SecHealthUI"; DISM /Online /Set-NonRemovableAppPolicy /PackageFamily:$($appx.PackageFamilyName) /NonRemovable:0 | Out-Null; Remove-AppxPackage -AllUsers -Package $appx.PackageFullName
