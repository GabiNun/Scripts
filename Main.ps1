...
schtasks /create /tn "RemoveDefenderAndSecurity" /ru "NT SERVICE\TrustedInstaller" /sc ONCE /st 00:00 /tr "cmd.exe /c regedit.exe /s %TEMP%\\RemoveDefender.reg && regedit.exe /s %TEMP%\\Remove_SecurityComp.reg" /f
